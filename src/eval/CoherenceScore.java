...
public class CoherenceScore {
	...
	public CoherenceScore(String documents, String doc_topics, int num_top_wrds){
		try{
			...
			br.close();
			calculate_topic_coherence(wordFreq, tupleFereq, topicWordFreq, topic_count, num_top_wrds, doc_number);
		}catch(Exception ex){
			ex.printStackTrace();
		}
	}
	...
	private void calculate_topic_coherence(
			...
			int num_top_wrds, int doc_number) {
		//##########################################################################################
